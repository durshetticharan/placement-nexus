-- Phase 15: Drive Experiences + Resources
-- Add ExperienceStatus, ExperienceDifficulty, ExperienceOutcome, ResourceCategory, ResourceStatus enums
-- Extend DriveExperience and DriveResource with student authorship and status enums
